...
namespace Cherry {
  ...
  static std::unordered_map<CherryKey, SDL_Scancode> keyMap = {
    { CherryKey::A, SDL_SCANCODE_A },           { CherryKey::B, SDL_SCANCODE_B },
    { CherryKey::C, SDL_SCANCODE_C },           { CherryKey::D, SDL_SCANCODE_D },
    { CherryKey::E, SDL_SCANCODE_E },           { CherryKey::F, SDL_SCANCODE_F },
    { CherryKey::G, SDL_SCANCODE_G },           { CherryKey::H, SDL_SCANCODE_H },
    { CherryKey::I, SDL_SCANCODE_I },           { CherryKey::J, SDL_SCANCODE_J },
    { CherryKey::K, SDL_SCANCODE_K },           { CherryKey::L, SDL_SCANCODE_L },
    { CherryKey::M, SDL_SCANCODE_M },           { CherryKey::N, SDL_SCANCODE_N },
    { CherryKey::O, SDL_SCANCODE_O },           { CherryKey::P, SDL_SCANCODE_P },
    { CherryKey::Q, SDL_SCANCODE_Q },           { CherryKey::R, SDL_SCANCODE_R },
    { CherryKey::S, SDL_SCANCODE_S },           { CherryKey::T, SDL_SCANCODE_T },
    { CherryKey::U, SDL_SCANCODE_U },           { CherryKey::V, SDL_SCANCODE_V },
    { CherryKey::W, SDL_SCANCODE_W },           { CherryKey::X, SDL_SCANCODE_X },
  ...
  class Application {
   public:
    ...
    void MultiThreadWindowRuntime();  // EXPERIMENTAL : Run in mutliple thread mode. (Worse for third party thread safety but
                                      // more performant.)
    ...
    void
    PopComponentArray();  // REstore previous component array, if 0 it will be created in the application component array
    // WARNING
    ...
    // FIXME : Component Arrays need also to be on the CherryID, when we create the component we see if the CherryID have a
    // group.
    ...
    //	-- Je crée le composant en faisant un GetComponentArray, il me donnera un array push si il y a eu un
    // PushComponentArray sans pop, 	   sinon il l créera dans le pool général.
    ...
    std::vector<std::pair<std::string, std::string>>
        m_PermanentProperties;  // Properties will be added in every component (until pop)
