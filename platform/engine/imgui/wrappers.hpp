...
namespace Cherry
{
    namespace GUI
    {
        ...
        bool ImageSizeButtonWithText(ImTextureID texId, float button_width, const char *label, const ImVec2 &imageSize = ImVec2(0, 0), const ImVec2 &uv0 = ImVec2(0, 0), const ImVec2 &uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4 &bg_col = ImVec4(0, 0, 0, 0), const ImVec4 &tint_col = ImVec4(1, 1, 1, 1));
        ...
        bool Begin(const char *name, ImTextureID logo, bool *p_open = NULL, ImGuiWindowFlags flags = 0, ImVec2 internal_padding = ImVec2(0, 0));
        ...
        bool InputTextWithImage(const char *label, ImTextureID texture, char *buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void *user_data = NULL);
        ...
        bool InputColorFloat(const char *label, float *v, ImVec4 color = ImVec4(0, 0, 0, 0), float step = 0.0f, float step_fast = 0.0f, const char *format = "%.3f", ImGuiInputTextFlags flags = 0);
        ...
        bool InputColorScalar(const char *label, ImGuiDataType data_type, ImVec4 color, void *p_data, const void *p_step = NULL, const void *p_step_fast = NULL, const char *format = NULL, ImGuiInputTextFlags flags = 0);
