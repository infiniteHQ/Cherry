...
namespace Cherry
{
    namespace GUI
    {
        ...
        bool ImageSizeButtonWithText(ImTextureID texId, float button_width, const char *label, const ImVec2 &imageSize, const ImVec2 &uv0, const ImVec2 &uv1, int frame_padding, const ImVec4 &bg_col, const ImVec4 &tint_col)
        {
            return ImGui::ImageSizeButtonWithText(texId, button_width, label, imageSize, uv0, uv1, frame_padding, bg_col, tint_col);
        }
        ...
        bool InputTextWithImage(const char *label, ImTextureID texture, char *buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void *user_data)
        {
        ...
        bool InputColorFloat(const char *label, float *v, ImVec4 color, float step, float step_fast, const char *format, ImGuiInputTextFlags flags)
        {
        ...
        bool InputColorScalar(const char *label, ImGuiDataType data_type, ImVec4 color, void *p_data, const void *p_step, const void *p_step_fast, const char *format, ImGuiInputTextFlags flags)
        {
