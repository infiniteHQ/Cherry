...
#include "Embed/WindowImages.embed"
    ...
    void Application::Init()
    {
        ...
        this->m_Windows.push_back(std::make_shared<Window>("2", 1800, 1000));
    }
    ...
    void MouseButtonCallback(GLFWwindow *window, int button, int action, int mods)
    {
        ...
        if (win)
        {
            ...
            std::cout << "MouseButtonCallback [" + std::to_string(button) + "](" + std::to_string(action) + ")(" + std::to_string(mods) + ")> " << win->GetName() << std::endl;
        }
        else
        {
            std::cout << "MouseButtonCallback empty" << std::endl;
        }
    }
    ...
    void MouseMoveCallback(GLFWwindow *window, double xpos, double ypos)
    {
        ...
        if (win)
        {
            ...
            std::cout << "MouseButtonCallback [X:" + std::to_string(xpos) + "/Y:" + std::to_string(ypos) + "]>" << win->GetName() << std::endl;
    ...
    ImDrawData *Application::RenderWindow(Window *window)
    {
        ...
        {
            std::cout << "Update click" << std::endl;
            if (window->m_PendingClick->button == GLFW_MOUSE_BUTTON_LEFT && window->m_PendingClick->action == GLFW_PRESS)
            {
                ImGuiIO &io = ImGui::GetIO();
                io.MouseDown[0] = true;
            }
            if (window->m_PendingClick->button == GLFW_MOUSE_BUTTON_LEFT && window->m_PendingClick->action == GLFW_RELEASE)
            {
                ImGuiIO &io = ImGui::GetIO();
                io.MouseDown[0] = false;
            }
            window->m_PendingClick = nullptr;
        }
