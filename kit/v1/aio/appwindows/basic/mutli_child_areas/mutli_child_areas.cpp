...
namespace Cherry
{
    ...
    std::shared_ptr<Cherry::AppWindow> &MultiChildAreas::GetAppWindow()
    {
        return m_AppWindow;
    }

    std::shared_ptr<MultiChildAreas> MultiChildAreas::Create(const std::string &name)
    {
    ...
    void MultiChildAreas::SetupRenderCallback()
    {
    ...
    void MultiChildAreas::Render()
    {
        if (m_IsHorizontal)
        {
            ...
            for (size_t i = 0; i < children.size(); ++i)
            {
                ...
                if (i + 1 < children.size() && !child.m_ResizeDisabled)
                {
                    ...
                    std::string lab = "##splitter" + child.m_Name + m_AppWindow->m_Name;
        ...
        else
        {
            ...
            for (size_t i = 0; i < children.size(); ++i)
            {
                ...
                std::string childname = child.m_Name + "##childnh" + m_AppWindow->m_Name;
