...
namespace Cherry
{
    namespace Components
    {
        ...
        {
        public:
            TooltipText(const Cherry::Identifier &id, const std::string &label, const std::string &description)
                : Component(id)
            {
                // Identifier
                SetIdentifier(id);
    ...
    namespace Kit
    {
        bool TooltipText(const std::string &label, const std::string &description)
        {
            // Inline component
            ...
            {
                auto button = Application::CreateAnonymousComponent<Components::TooltipText>(Components::TooltipText(anonymous_id, label, description));
                button->Render();
        ...
        bool TooltipText(const Cherry::Identifier &identifier, const std::string &label, const std::string &description)
        {
            ...
            else
            {
                ...
                auto new_button = Application::CreateComponent<Components::TooltipText>(Components::TooltipText(identifier, label, description));
                new_button->Render();
