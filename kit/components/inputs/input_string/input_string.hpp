...
namespace Cherry
{
    ...
    namespace Kit
    {
        std::shared_ptr<Component> InputString(const std::string &label, std::string *value)
        {
            // Inline component
        ...
        std::shared_ptr<Component> InputString(const Cherry::Identifier &identifier, const std::string &label, std::string *value)
        {
