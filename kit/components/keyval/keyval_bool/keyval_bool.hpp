...
namespace Cherry {
  namespace Components {
    class KeyValBool : public Component {
     public:
      KeyValBool(const Cherry::Identifier &id, const std::string &label, bool *value) : Component(id), m_Value(value) {
        // Identifier
        SetIdentifier(id);
  ...
  // End-User API
  namespace Kit {
    inline Component &KeyValBool(const Identifier &identifier, const std::string &label, bool *value) {
      return CherryApp.PushComponent<Cherry::Components::KeyValBool>(identifier, label, value);
    }

    inline Component &KeyValBool(const std::string &label, bool *value) {
      return Cherry::Kit::KeyValBool(Application::GenerateUniqueID(label, value, "KeyValBool"), label, value);
    }
  }  // namespace Kit
