...
namespace Cherry
{
    ...
    namespace Kit
    {
        inline std::shared_ptr<Component> KeyValDouble(const std::string &label, double *value)
        {
            // Inline component
            ...
            else
            {
                ...
                auto button = Application::CreateAnonymousComponent<Components::KeyValDouble>(Components::KeyValDouble(anonymous_id, label, value));
                button->Render();
                return button;
            }
        }

        inline std::shared_ptr<Component> KeyValDouble(const Cherry::Identifier &identifier, const std::string &label, double *value)
        {
