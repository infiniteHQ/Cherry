...
namespace Cherry {
  ...
  namespace Kit {
    inline Component &BlockVerticalCustom(
        ...
        const std::vector<std::function<void()>> &renderCallbacks) {
      return CherryApp.PushComponent<Cherry::Components::BlockVerticalCustom>(identifier, renderCallbacks);
    }

    inline Component &BlockVerticalCustom(const std::vector<std::function<void()>> &renderCallbacks) {
      return Cherry::Kit::BlockVerticalCustom(
          Application::GenerateUniqueID(renderCallbacks, "BlockVerticalCustom"), renderCallbacks);
    }
    ...
    inline Component &BlockVerticalCustom(
        ...
        int i = 0) {
      return Cherry::Kit::BlockVerticalCustom(
          Application::GenerateUniqueID(onClickedCallback, width, height, renderCallbacks, i, "BlockVerticalCustom"),
          onClickedCallback,
          width,
          height,
          renderCallbacks,
