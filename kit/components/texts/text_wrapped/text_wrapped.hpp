...
namespace Cherry
{
    ...
    namespace Kit
    {
        std::shared_ptr<Component> TextWrapped(const std::string &label)
        {
            // Inline component
        ...
        std::shared_ptr<Component> TextWrapped(const Cherry::Identifier &identifier, const std::string &label)
        {
