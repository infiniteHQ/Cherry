...
namespace Cherry {
  ...
  // End-User API
  namespace Kit {
    inline Component &PlotHistorigramFloat(
    ...
    inline Component &
    PlotHistorigramFloat(const std::string &label, const std::vector<float> &float_table, int number_showed = -1) {
      return Cherry::Kit::PlotHistorigramFloat(
          Application::GenerateUniqueID(label, float_table, number_showed, "PlotHistorigramFloat"),
          label,
          float_table,
          number_showed);
    }
    ...
    inline Component &
    PlotHistorigramFloat(const std::string &label, const std::vector<float> &float_table, int *number_showed) {
      return Cherry::Kit::PlotHistorigramFloat(
          Application::GenerateUniqueID(label, float_table, number_showed, "PlotHistorigramFloat"),
          label,
          float_table,
