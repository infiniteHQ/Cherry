...
namespace Cherry
{
    ...
    namespace Kit
    {
        bool PlotHistorigramFloat(const std::string &label, const std::vector<float> &float_table, int number_showed = -1)
        {
            // Inline component
        ...
        bool PlotHistorigramFloat(const Cherry::Identifier &identifier, const std::string &label, const std::vector<float> &float_table, int number_showed = -1)
        {
        ...
        bool PlotHistorigramFloat(const std::string &label, const std::vector<float> &float_table, int *number_showed)
        {
            // Inline component
            auto anonymous_id = Application::GetAnonymousID();
            auto existing = Application::GetAnonymousComponent(anonymous_id);
        ...
        bool PlotHistorigramFloat(const Cherry::Identifier &identifier, const std::string &label, const std::vector<float> &float_table, int *number_showed)
        {
            // Get the object if exist
            auto existing_button = Application::GetComponent(identifier);
            if (existing_button)
