    ...
    namespace Components
    {
        ...
        public:
                ...
                : Component(id)
            {
                ...
                // Images
                SetProperty("image_dropdown_up", Cherry::GetPath("resources/base/dropdown_up.png"));
                SetProperty("image_dropdown_down", Cherry::GetPath("resources/base/dropdown_down.png"));
