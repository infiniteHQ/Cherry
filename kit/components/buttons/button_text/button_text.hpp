...
namespace Cherry
{
    namespace Components
    {
        ...
        public:
            ...
            void Render() override
            {
                ...
                bool isClicked = ImGui::Button(Label.c_str(), size);
    ...
    namespace Kit
    {
        std::shared_ptr<Component> ButtonText(const std::string &label)
        {
            ...
            {
                auto title = Application::CreateAnonymousComponent<Components::ButtonText>(Components::ButtonText(Cherry::Identifier(""), label));
                title->Render();
                return title;
            }
        }

        std::shared_ptr<Component> ButtonText(const Cherry::Identifier &identifier, const std::string &label)
        {
            if (identifier.string() == "__inline")
            {
                auto new_title = Application::CreateAnonymousComponent<Components::ButtonText>(Components::ButtonText(identifier, label));
                new_title->Render();
                return new_title;
            }
            ...
            else
            {
                ...
                auto new_title = Application::CreateComponent<Components::ButtonText>(Components::ButtonText(identifier, label));
                new_title->Render();
                return new_title;
            }
