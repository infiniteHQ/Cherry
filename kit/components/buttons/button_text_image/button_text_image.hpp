...
namespace Cherry
{
    ...
    namespace Kit
    {
        inline std::shared_ptr<Component> ButtonTextImage(const std::string &label, const std::string &image_path)
        {
            // Inline component
            ...
            {
                auto button = Application::CreateAnonymousComponent<Components::ButtonTextImage>(Components::ButtonTextImage(Cherry::Identifier(""), label, image_path));
                button->Render();
                return button;
            } }

        inline std::shared_ptr<Component> ButtonTextImage(const Cherry::Identifier &identifier, const std::string &label, const std::string &image_path)
        {
            if (identifier.string() == "__inline")
            {
                auto new_button = Application::CreateAnonymousComponent<Components::ButtonTextImage>(Components::ButtonTextImage(identifier, label, image_path));
                new_button->Render();
                return new_button;
            }
