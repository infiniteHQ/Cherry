...
namespace Cherry
{
    ...
    namespace Kit
    {
        inline std::shared_ptr<Component> ButtonImageDropdown(const std::string &image_path, const std::function<void()> &dropdown_callback = []() {})
        {
        ...
        inline std::shared_ptr<Component> ButtonImageDropdown(const Cherry::Identifier &identifier, const std::string &image_path, const std::function<void()> &dropdown_callback = []() {})
        {
            ...
            {
                auto new_button = Application::CreateAnonymousComponent<Components::ButtonImageDropdown>(Components::ButtonImageDropdown(identifier, image_path, dropdown_callback));
                new_button->Render();
                return new_button;
            }
            ...
            else
            {
                ...
                auto new_button = Application::CreateComponent<Components::ButtonImageDropdown>(Components::ButtonImageDropdown(identifier, image_path, dropdown_callback));
                new_button->Render();
                return new_button;
            }
