...
public:
  ButtonTextImageDropdown(const Cherry::Identifier &id,
  ...
  void Render() override {
    ...
    bool isClicked = CherryGUI::TextButtonWithImageWithIcon(
        image_texture, texture, Label.c_str(), size);
...
inline Component &ButtonTextImageDropdown(
  ...
  return Cherry::Kit::ButtonTextImageDropdown(
      Application::GenerateUniqueID(label, image_path, dropdown_callback,
                                    "ButtonTextImageDropdown"),
