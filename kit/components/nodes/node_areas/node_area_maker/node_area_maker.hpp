...
namespace Cherry
{
    namespace Components
    {
        ...
        {
        public:
            NodeAreaMaker(const Cherry::Identifier &id, const std::string &label, int width, int height)
                : Component(id)
            {
                // Identifier
                SetIdentifier(id);
    ...
    namespace Kit
    {
        inline std::shared_ptr<Component> NodeAreaMaker(const std::string &label, int width, int height, const std::vector<std::shared_ptr<Component>>& node_array = {})
        {
            // Inline component
            ...
            {
                auto button = Application::CreateAnonymousComponent<Components::NodeAreaMaker>(Components::NodeAreaMaker(anonymous_id, label, width, height));
                button->Render();
                return button;
            }
        }

        inline std::shared_ptr<Component> NodeAreaMaker(const Cherry::Identifier &identifier, const std::string &label, int width, int height)
        {
            ...
            else
            {
                ...
                auto new_button = Application::CreateComponent<Components::NodeAreaMaker>(Components::NodeAreaMaker(identifier, label, width, height));
                new_button->Render();
                return new_button;
            }
        }
