...
class NodeAreaMaker : public Component {
public:
  NodeAreaMaker(const Cherry::Identifier &id, const std::string &label,
  ...
  void BuildNodes() {
    ...
    // Register these nodes into a special array on this node area with all area
    // properties (connections, emplacements, etc...) Can Dump this register
    ...
    m_NodeEngine->m_Links.push_back(Link(
        m_NodeEngine->GetNextLinkId(), m_NodeEngine->m_Nodes[5].Outputs[0].ID,
        m_NodeEngine->m_Nodes[6].Inputs[0].ID));
    m_NodeEngine->m_Links.push_back(Link(
        m_NodeEngine->GetNextLinkId(), m_NodeEngine->m_Nodes[5].Outputs[0].ID,
        m_NodeEngine->m_Nodes[7].Inputs[0].ID));

    m_NodeEngine->m_Links.push_back(Link(
        m_NodeEngine->GetNextLinkId(), m_NodeEngine->m_Nodes[14].Outputs[0].ID,
        m_NodeEngine->m_Nodes[15].Inputs[0].ID));
  }
              ...
              // }
                ...
                if (ed::AcceptNewItem(ImColor(128, 255, 128), 4.0f)) {
                  ...
                  m_NodeEngine->m_Links.back().Color =
                      m_NodeEngine->GetIconColor(startPin->Type);
                }
              }
            }
          }
