...
#ifndef CHERRY_KIT_THEME_LIGHT_VORTEX
#define CHERRY_KIT_THEME_LIGHT_VORTEX

namespace Cherry {
namespace Themes {
class LightVortex : public Theme {
public:
  LightVortex() {
    SetName("light_vortex");
...
#endif // CHERRY_KIT_THEME_LIGHT_VORTEX
