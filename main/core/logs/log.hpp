  ...
  class Log {
   public:
    ...
    static void Print(Level level, std::string_view tag, const char *fmt, ...) {
      ...
      out << "[" << timeBuffer << "." << std::setfill('0') << std::setw(3) << ms.count() << "] " << color << "["
   ...
   private:
    ...
    static constexpr const char *GetLevelColor(Level level) {
      switch (level) {
        ...
        case Level::Fatal: return "\033[41m\033[37m";
...
#define CH_TRACE(...) ::Cherry::Log::Print(::Cherry::Log::Level::Trace, "", __VA_ARGS__)
#define CH_INFO(...)  ::Cherry::Log::Print(::Cherry::Log::Level::Info, "", __VA_ARGS__)
#define CH_WARN(...)  ::Cherry::Log::Print(::Cherry::Log::Level::Warn, "", __VA_ARGS__)
#define CH_ERROR(...) ::Cherry::Log::Print(::Cherry::Log::Level::Error, "", __VA_ARGS__)
#define CH_FATAL(...) ::Cherry::Log::Print(::Cherry::Log::Level::Fatal, "", __VA_ARGS__)

#define CH_TRACE_TAG(tag, ...) ::Cherry::Log::Print(::Cherry::Log::Level::Trace, tag, __VA_ARGS__)
#define CH_INFO_TAG(tag, ...)  ::Cherry::Log::Print(::Cherry::Log::Level::Info, tag, __VA_ARGS__)
#define CH_WARN_TAG(tag, ...)  ::Cherry::Log::Print(::Cherry::Log::Level::Warn, tag, __VA_ARGS__)
#define CH_ERROR_TAG(tag, ...) ::Cherry::Log::Print(::Cherry::Log::Level::Error, tag, __VA_ARGS__)
#define CH_FATAL_TAG(tag, ...) ::Cherry::Log::Print(::Cherry::Log::Level::Fatal, tag, __VA_ARGS__)
