  ...
  namespace NodeSystem {
    ...
    class NodeSchema {
     public:
      ...
      std::string GetHexHeaderColor() const {
        return m_HexHeaderColor;
      }
      std::string GetHexBorderColor() const {
        return m_HexBorderColor;
      }
      std::string GetHexBackgroundColor() const {
        return m_HexBackgroundColor;
      }
      std::string GetLabel() const {
        return m_Label;
      }
      std::string GetLabelHexColor() const {
        return m_LabelHexColor;
      }
      std::string GetSecondLabel() const {
        return m_SecondLabel;
      }
      std::string GetSecondLabelHexColor() const {
        return m_SecondLabelHexColor;
      }
      std::string GetDescriptionHexColor() const {
        return m_DescriptionHexColor;
      }
      std::string GetLogoPath() const {
        return m_HeaderLogoPath;
      }
      NodeType GetType() const {
        return m_NodeType;
      }

      void SetHexHeaderColor(const std::string &color) {
        m_HexHeaderColor = color;
      }
      void SetHexBorderColor(const std::string &color) {
        m_HexBorderColor = color;
      }
      void SetHexBackgroundColor(const std::string &color) {
        m_HexBackgroundColor = color;
      }
      void SetLabel(const std::string &label) {
        m_Label = label;
      }
      void SetLabelHexColor(const std::string &color) {
        m_LabelHexColor = color;
      }
      void SetSecondLabel(const std::string &label) {
        m_SecondLabel = label;
      }
      void SetSecondLabelHexColor(const std::string &color) {
        m_SecondLabelHexColor = color;
      }
      void SetDescriptionHexColor(const std::string &color) {
        m_DescriptionHexColor = color;
      }
      void SetLogoPath(const std::string &path) {
        m_HeaderLogoPath = path;
      }
      ...
      std::string m_HeaderLogoPath;

      NodeSchemaStatus m_NodeStatus = NodeSchemaStatus::Active;
