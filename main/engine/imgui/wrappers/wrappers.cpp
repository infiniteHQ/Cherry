...
namespace Cherry {
  namespace GUI {
    ...
    void
    AddRectFilled(ImDrawList *ptr, const ImVec2 &p_min, const ImVec2 &p_max, ImU32 col, float rounding, ImDrawFlags flags) {
    ...
    bool ImageButtonWithTextWithIcon(
      ...
      return ImGui::ImageButtonWithTextWithIcon(
          texIdFirst, texIdSecond, label, imageSizeFirst, imageSizeSecond, uv0, uv1, frame_padding, bg_col, tint_col);
    }
    ...
    bool ImageSizeButtonWithText(
        ...
        const ImVec4 &bg_col,
        const ImVec4 &tint_col) {
      return ImGui::ImageSizeButtonWithText(
          texId, button_width, label, imageSize, uv0, uv1, frame_padding, bg_col, tint_col);
    }
    ...
    bool BeginCombo(const char *label, const std::function<void()> &preview, ImGuiComboFlags flags) {
    ...
    bool
    Combo(const char *label, int *current_item, const char *const items[], int items_count, int popup_max_height_in_items) {
    ...
    void PlotLines(
        ...
        ImVec2 graph_size) {
      ImGui::PlotLines(
          label, values_getter, data, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size);
    }
    ...
    void PlotHistogram(
        ...
        int stride) {
      ImGui::PlotHistogram(
          label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
    }
    ...
    bool Begin(const char *name, ImTextureID logo, bool *p_open, ImGuiWindowFlags flags, ImVec2 internal_padding) {
    ...
    bool InputTextWithImage(
        ...
        ImGuiInputTextCallback callback,
        void *user_data) {
      return ImGui::InputTextWithImage(label, texture, buf, buf_size, flags, callback, user_data);
    }
    ...
    bool
    InputFloat(const char *label, float *v, float step, float step_fast, const char *format, ImGuiInputTextFlags flags) {
    ...
    bool InputColorFloat(
        ...
        const char *format,
        ImGuiInputTextFlags flags) {
      return ImGui::InputColorFloat(label, v, color, step, step_fast, format, flags);
    }
    ...
    bool
    InputDouble(const char *label, double *v, double step, double step_fast, const char *format, ImGuiInputTextFlags flags) {
    ...
    bool InputColorScalar(
        ...
        const char *format,
        ImGuiInputTextFlags flags) {
      return ImGui::InputColorScalar(label, data_type, color, p_data, p_step, p_step_fast, format, flags);
    }
    ...
    void RenderRectFilledRangeH(
        ...
        float x_end_norm,
        float rounding) {
      ImGui::RenderRectFilledRangeH(draw_list, rect, col, x_start_norm, x_end_norm, rounding);
    }
    ...
    bool
    DragInt(const char *label, int *v, float v_speed, int v_min, int v_max, const char *format, ImGuiSliderFlags flags) {
      return ImGui::DragInt(label, v, v_speed, v_min, v_max, format, flags);
    }

    bool
    DragInt2(const char *label, int v[2], float v_speed, int v_min, int v_max, const char *format, ImGuiSliderFlags flags) {
      return ImGui::DragInt2(label, v, v_speed, v_min, v_max, format, flags);
    }

    bool
    DragInt3(const char *label, int v[3], float v_speed, int v_min, int v_max, const char *format, ImGuiSliderFlags flags) {
      return ImGui::DragInt3(label, v, v_speed, v_min, v_max, format, flags);
    }

    bool
    DragInt4(const char *label, int v[4], float v_speed, int v_min, int v_max, const char *format, ImGuiSliderFlags flags) {
