//
//  app_window.hpp
//  Headers for app windows of cherry
//
...
namespace Cherry {
  ...
  class CHERRY_API AppWindow {
   public:
    ...
    std::shared_ptr<RedockRequest> CreateRedockEvent(
        const std::string &parentWindow,
        DockEmplacement emplacement,
        const bool &fromSave = false,
   ...
   public:
    ...
    std::string m_PreviousDockingAppWindow = "none";
    std::string m_PreviousDockingAnchor = "none";
    int m_FrameCounterPreventUndock = 0;
