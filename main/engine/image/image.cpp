//
//  image.cpp
//  Sources for images system of Cherry
//
...
namespace Cherry {
  ...
  Image::Image(std::string_view path, const std::string &winname) : m_Filepath(path), m_Winname(winname) {
  ...
  ImTextureID Image::GetImGuiTextureID(VkImageLayout layout) const {
