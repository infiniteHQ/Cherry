//
//  api_drawing.cpp
//  Main scripting API in lua for all drawing features of Cherry
//
...
namespace Cherry {
  namespace Script {
    ...
    LUA_FUNC(DrawRect) {
      ...
      Cherry::Drawing::RectWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color);
    ...
    LUA_FUNC(DrawRectFixed) {
      ...
      Cherry::Drawing::RectScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color);
    ...
    LUA_FUNC(DrawRectOutline) {
      ...
      Cherry::Drawing::RectOutlineWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color, thickness);
    ...
    LUA_FUNC(DrawRectOutlineFixed) {
      ...
      Cherry::Drawing::RectOutlineScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color, thickness);
    ...
    LUA_FUNC(DrawText) {
      ...
      Cherry::Drawing::TextWindow(text, Cherry::Vec2(x, y), size, color);
    ...
    LUA_FUNC(DrawTextFixed) {
      ...
      Cherry::Drawing::TextScreen(text, Cherry::Vec2(x, y), size, color);
    ...
    LUA_FUNC(DrawLine) {
      ...
      Cherry::Drawing::LineWindow(Cherry::Vec2(sx, sy), Cherry::Vec2(ex, ey), color, thickness);
    ...
    LUA_FUNC(DrawLineFixed) {
      ...
      Cherry::Drawing::LineScreen(Cherry::Vec2(sx, sy), Cherry::Vec2(ex, ey), color, thickness);
    ...
    LUA_FUNC(DrawLineHorizontal) {
      ...
      Cherry::Drawing::LineHWindow(y, sx, ex, color, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawLineHorizontalFixed) {
      ...
      Cherry::Drawing::LineHScreen(y, sx, ex, color, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawLineVertical) {
      ...
      Cherry::Drawing::LineVWindow(x, sy, ey, color, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawLineVerticalFixed) {
      ...
      Cherry::Drawing::LineVScreen(x, sy, ey, color, thickness);
      return 0;
    }
    LUA_FUNC(DrawPolyline) {
      ...
      Cherry::Drawing::PolylineWindow(points, color, thickness);
    ...
    LUA_FUNC(DrawPolylineFixed) {
      ...
      std::string color = static_cast<std::string>(lua_tostring(L, 2));
      float thickness = (float)lua_tonumber(L, 3);
      Cherry::Drawing::PolylineScreen(points, color, thickness);
    ...
    LUA_FUNC(DrawCross) {
      ...
      Cherry::Drawing::CrossWindow(Cherry::Vec2(x, y), size, color, thickness);
    ...
    LUA_FUNC(DrawCrossFixed) {
      ...
      Cherry::Drawing::CrossScreen(Cherry::Vec2(x, y), size, color, thickness);
    ...
    LUA_FUNC(DrawSquare) {
      ...
      Cherry::Drawing::SquareWindow(Cherry::Vec2(x, y), size, color);
    ...
    LUA_FUNC(DrawSquareFixed) {
      ...
      Cherry::Drawing::SquareScreen(Cherry::Vec2(x, y), size, color);
    ...
    LUA_FUNC(DrawQuad) {
      ...
      Cherry::Drawing::QuadWindow(
          Cherry::Vec2(x0, y0), Cherry::Vec2(x1, y1), Cherry::Vec2(x2, y2), Cherry::Vec2(x3, y3), color);
    ...
    LUA_FUNC(DrawCircle) {
      ...
      Cherry::Drawing::CircleWindow(Cherry::Vec2(x, y), radius, color, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleFixed) {
      ...
      Cherry::Drawing::CircleScreen(Cherry::Vec2(x, y), radius, color, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleOutline) {
      ...
      Cherry::Drawing::CircleOutlineWindow(Cherry::Vec2(x, y), radius, color, thickness, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleOutlineFixed) {
      ...
      Cherry::Drawing::CircleOutlineScreen(Cherry::Vec2(x, y), radius, color, thickness, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawTriangle) {
      ...
      Cherry::Drawing::TriangleWindow(p1, p2, p3, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawTriangleFixed) {
      ...
      Cherry::Drawing::TriangleScreen(p1, p2, p3, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectRounded) {
      ...
      Cherry::Drawing::RectRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectOutlineRounded) {
      ...
      Cherry::Drawing::RectOutlineRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectRoundedFixed) {
      ...
      Cherry::Drawing::RectRoundedScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageRounded) {
      ...
      std::string color = (lua_gettop(L) >= 7) ? static_cast<std::string>(lua_getstring(L, 7)) : "#FFFFFFFF";

      Cherry::Drawing::ImageRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), path, rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageRoundedFixed) {
      ...
      Cherry::Drawing::ImageRoundedScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), path, rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImage) {
      ...
      std::string color = (lua_gettop(L) >= 10) ? static_cast<std::string>(lua_getstring(L, 10)) : "#FFFFFFFF";

      Cherry::Drawing::ImageWindow({ x, y }, { w, h }, path, { uv_min_x, uv_min_y }, { uv_max_x, uv_max_y }, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageFixed) {
      ...
      Cherry::Drawing::ImageScreen({ x, y }, { w, h }, path, { uv_min_x, uv_min_y }, { uv_max_x, uv_max_y }, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageQuad) {
      ...
      Cherry::Drawing::ImageQuadWindow(p1, p2, p3, p4, path, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageQuadFixed) {
      ...
      Cherry::Drawing::ImageQuadScreen(p1, p2, p3, p4, path, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradient) {
      ...
      Cherry::Drawing::RectGradientWindow({ x, y }, { w, h }, c1, c2, vertical, steps);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradientFixed) {
      ...
      Cherry::Drawing::RectGradientScreen({ x, y }, { w, h }, c1, c2, vertical, steps);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradientRounded) {
      ...
      Cherry::Drawing::RectGradientRoundedWindow({ x, y }, { w, h }, c1, c2, rounded, vertical);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradientRoundedFixed) {
      ...
      Cherry::Drawing::RectGradientRoundedScreen({ x, y }, { w, h }, c1, c2, rounded, vertical);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectOutlineGradient) {
      ...
      Cherry::Drawing::RectOutlineGradientWindow({ x, y }, { w, h }, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectOutlineGradientFixed) {
      ...
      Cherry::Drawing::RectOutlineGradientScreen({ x, y }, { w, h }, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleGradient) {
      ...
      Cherry::Drawing::CircleGradientWindow({ x, y }, radius, c1, c2, steps);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleGradientFixed) {
      ...
      Cherry::Drawing::CircleGradientScreen({ x, y }, radius, c1, c2, steps);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleOutlineGradient) {
      ...
      Cherry::Drawing::CircleOutlineGradientWindow({ x, y }, radius, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleOutlineGradientFixed) {
      ...
      Cherry::Drawing::CircleOutlineGradientScreen({ x, y }, radius, c1, c2, thickness);
      return 0;
    }
    LUA_FUNC(DrawTriangleGradient) {
      ...
      Cherry::Drawing::TriangleGradientWindow(p1, p2, p3, c1, c2, c3);
      return 0;
    }
    ...
    LUA_FUNC(DrawTriangleGradientFixed) {
      ...
      Cherry::Drawing::TriangleGradientScreen(p1, p2, p3, c1, c2, c3);
      return 0;
    }
    ...
    LUA_FUNC(DrawTriangleOutlineGradient) {
      ...
      Cherry::Drawing::TriangleOutlineGradientWindow(p1, p2, p3, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawTriangleOutlineGradientFixed) {
      ...
      Cherry::Drawing::TriangleOutlineGradientScreen(p1, p2, p3, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawQuadGradient) {
      ...
      Cherry::Drawing::QuadGradientWindow(p1, p2, p3, p4, c1, c2, c3, c4);
      return 0;
    }
    ...
    LUA_FUNC(DrawQuadGradientFixed) {
      ...
      std::string c3 = lua_getstring(L, 11);
      std::string c4 = lua_getstring(L, 12);
      Cherry::Drawing::QuadGradientScreen(p1, p2, p3, p4, c1, c2, c3, c4);
      return 0;
    }
    ...
    LUA_FUNC(DrawQuadOutlineGradient) {
      ...
      Cherry::Drawing::QuadOutlineGradientWindow(p1, p2, p3, p4, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawQuadOutlineGradientFixed) {
      ...
      Cherry::Drawing::QuadOutlineGradientScreen(p1, p2, p3, p4, c1, c2, thickness);
      return 0;
    }
    ...
    LUA_FUNC(BeginRectMask) {
      ...
      Cherry::Drawing::BeginRectMask({ x, y }, { w, h }, intersect);
      return 0;
    }
    ...
    LUA_FUNC(BeginRectMaskFixed) {
      ...
      Cherry::Drawing::BeginRectMaskFixed({ x, y }, { w, h }, intersect);
      return 0;
    }

    LUA_FUNC(EndRectMaskFixed) {
      Cherry::Drawing::EndRectMaskFixed();
      return 0;
    }
