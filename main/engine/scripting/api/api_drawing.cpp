...
namespace Cherry {
  namespace Script {
    ...
    LUA_FUNC(DrawRectOutline) {
      ...
      Cherry::Draw::RectOutlineWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color, thickness);
    ...
    LUA_FUNC(DrawRectOutlineFixed) {
      ...
      Cherry::Draw::RectOutlineScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), color, thickness);
    ...
    LUA_FUNC(DrawLine) {
      ...
      Cherry::Draw::LineWindow(Cherry::Vec2(sx, sy), Cherry::Vec2(ex, ey), color, thickness);
    ...
    LUA_FUNC(DrawLineFixed) {
      ...
      Cherry::Draw::LineScreen(Cherry::Vec2(sx, sy), Cherry::Vec2(ex, ey), color, thickness);
    ...
    LUA_FUNC(DrawCircleOutline) {
      ...
      Cherry::Draw::CircleOutlineWindow(Cherry::Vec2(x, y), radius, color, thickness, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawCircleOutlineFixed) {
      ...
      Cherry::Draw::CircleOutlineScreen(Cherry::Vec2(x, y), radius, color, thickness, segments);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectRounded) {
      ...
      Cherry::Draw::RectRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectOutlineRounded) {
      ...
      Cherry::Draw::RectOutlineRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color, thickness);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectRoundedFixed) {
      ...
      Cherry::Draw::RectRoundedScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageRounded) {
      ...
      Cherry::Draw::ImageRoundedWindow(Cherry::Vec2(x, y), Cherry::Vec2(w, h), path, rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageRoundedFixed) {
      ...
      Cherry::Draw::ImageRoundedScreen(Cherry::Vec2(x, y), Cherry::Vec2(w, h), path, rounding, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImage) {
      ...
      Cherry::Draw::ImageWindow({ x, y }, { w, h }, path, { uv_min_x, uv_min_y }, { uv_max_x, uv_max_y }, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawImageFixed) {
      ...
      Cherry::Draw::ImageScreen({ x, y }, { w, h }, path, { uv_min_x, uv_min_y }, { uv_max_x, uv_max_y }, color);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradientRounded) {
      ...
      Cherry::Draw::RectGradientRoundedWindow({ x, y }, { w, h }, c1, c2, rounded, vertical);
      return 0;
    }
    ...
    LUA_FUNC(DrawRectGradientRoundedFixed) {
      ...
      Cherry::Draw::RectGradientRoundedScreen({ x, y }, { w, h }, c1, c2, rounded, vertical);
      return 0;
    }
