...
namespace Cherry {
    ...
    class BlockHorizontalCustom : public Component {
     public:
      BlockHorizontalCustom(
        ...
        SetProperty("block_border_color_hovered", "theme:block_border_color_hovered");
        SetProperty("block_border_color_pressed", "theme:block_border_color_pressed");
      ...
      void Render() override {
        ...
        if (CherryGUI::BeginChild(
                label.c_str(), cachedSize, false, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse)) {
  ...
  namespace Kit {
    inline Component &BlockHorizontalCustom(
        ...
        const std::vector<std::function<void()>> &renderCallbacks) {
      return CherryApp.PushComponent<Cherry::Components::BlockHorizontalCustom>(identifier, renderCallbacks);
    }

    inline Component &BlockHorizontalCustom(const std::vector<std::function<void()>> &renderCallbacks) {
      return Cherry::Kit::BlockHorizontalCustom(
          Application::GenerateUniqueID(renderCallbacks, "BlockHorizontalCustom"), renderCallbacks);
    }
    ...
    inline Component &BlockHorizontalCustom(
        ...
        int i = 0) {
      return Cherry::Kit::BlockHorizontalCustom(
          Application::GenerateUniqueID(onClickedCallback, width, height, renderCallbacks, i, "BlockHorizontalCustom"),
          onClickedCallback,
          width,
          height,
          renderCallbacks,
