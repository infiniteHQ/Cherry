...
namespace Cherry {
    ...
    class ButtonTextImageDropdown : public Component {
     public:
      ...
      void Render() override {
        ...
        ImTextureID image_texture = Application::Get().GetCurrentRenderedWindow()->GetTexture(GetProperty("image_path"));
  ...
  // End-User API
  namespace Kit {
    inline Component &ButtonTextImageDropdown(
        const Identifier &identifier,
        const std::string &label,
        const std::string &image_path,
        const std::function<void()> &dropdown_callback = []() { }) {
      return CherryApp.PushComponent<Cherry::Components::ButtonTextImageDropdown>(
    ...
    inline Component &ButtonTextImageDropdown(
        ...
        const std::string &image_path,
        const std::function<void()> &dropdown_callback = []() { }) {
      return Cherry::Kit::ButtonTextImageDropdown(
          Application::GenerateUniqueID(label, image_path, dropdown_callback, "ButtonTextImageDropdown"),
          label,
          image_path,
          dropdown_callback);
    }
