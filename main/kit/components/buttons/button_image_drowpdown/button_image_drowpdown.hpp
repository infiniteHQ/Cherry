//
//  button_image_drowpdown.hpp
//  Simple header for image button with dropdown component
//
...
namespace Cherry {
  ...
  namespace Kit {
    inline Component &ButtonImageDropdown(
        ...
        const std::string &image_path,
        const std::function<void()> &dropdown_callback = []() { }) {
      return CherryApp.PushComponent<Cherry::Components::ButtonImageDropdown>(identifier, image_path, dropdown_callback);
    }
    ...
    inline Component &ButtonImageDropdown(
      ...
      return Cherry::Kit::ButtonImageDropdown(
          Application::GenerateUniqueID(image_path, dropdown_callback, "ButtonImageDropdown"),
          image_path,
          dropdown_callback);
    }
  }  // namespace Kit
