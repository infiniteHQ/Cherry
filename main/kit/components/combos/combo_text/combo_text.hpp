...
namespace Cherry {
  ...
  namespace Kit {
    ...
    inline Component &ComboText(
        const Identifier &identifier,
        const std::string &label,
        std::vector<std::string> *list,
        int default_index = 0) {
      return CherryApp.PushComponent<Cherry::Components::ComboText>(identifier, label, list, default_index);
    }

    inline Component &ComboText(const std::string &label, std::vector<std::string> *list, int default_index = 0) {
      return Cherry::Kit::ComboText(
          Application::GenerateUniqueID(label, list, default_index, "ComboText"), label, list, default_index);
    }
