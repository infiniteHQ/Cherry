    ...
    class NotificationButton : public Component {
     public:
      NotificationButton(
        ...
        SetProperty("color_border_hovered", "theme:notification_color_border_hovered");
    ...
    inline Component &NotificationButton(
      ...
      return Cherry::Kit::NotificationButton(
          Application::GenerateUniqueID(
              activate, timer_in_seconds, type, title, description, button_callback, "NotificationButton"),
          activate,
          timer_in_seconds,
          type,
          title,
