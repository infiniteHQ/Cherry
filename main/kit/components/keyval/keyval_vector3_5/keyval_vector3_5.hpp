...
namespace Cherry {
            ...
            if (m_XValue && m_YValue && m_ZValue && m_XWValue && m_YWValue && m_ZWValue) {
              ...
              for (int i = 0; i < 3; ++i) {
                ...
                CherryGUI::SetCursorScreenPos(
                    ImVec2(pos.x + colorBoxWidth + spacing, pos.y + CherryGUI::GetTextLineHeightWithSpacing()));
  ...
  // End-User API
  namespace Kit {
    inline Component &KeyValVector3_5(
      ...
      return CherryApp.PushComponent<Cherry::Components::KeyValVector3_5>(
          identifier, label, x_value, y_value, z_value, xw_value, yw_value, zw_value);
    }
