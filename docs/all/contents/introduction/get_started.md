...
Next, verify that you have obtained a functional copy of Cherry. It is essential to use a Release version by running `git checkout 1.6` to get the latest released version of Cherry.
