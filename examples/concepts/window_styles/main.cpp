...
void AppWindowRender() {
  ...
  CherryKit::TextSimple("I'm \"" + AppWindowName + "\" and i'm on the window \"" + WindowName + "\"");
}
...
CherryApplication CherryMain(int argc, char **argv) {
  ...
  Cherry::AddAppWindow(CherryKit::WindowSimple("App Window 1", AppWindowRender));
  Cherry::AddAppWindow(CherryKit::WindowSimple("App Window 2", AppWindowRender));
  Cherry::AddAppWindow(CherryKit::WindowSimple("App Window 3", AppWindowRender));
  return app;
}
